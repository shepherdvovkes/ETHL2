    ...
    try:
        ...
        for asset_id, symbol in assets:
            ...
            for day in range(7):
                ...
                security_metrics['security_score'] = SecurityScoreCalculator.calculate_asset_security_score(security_metrics)
                ...
                cursor.execute("""
                    INSERT INTO security_metrics (
                        ...
                        overflow_protection, access_control, pause_functionality, security_score
                    ) VALUES (
                        ...
                        %(overflow_protection)s, %(access_control)s, %(pause_functionality)s, %(security_score)s
                    )
                """, security_metrics)
